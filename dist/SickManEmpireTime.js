...
if ( typeof define === "function" && define.amd ) {
	define( "SickManEmpireTime", [], function() {
...
SickManEmpireTime.noConflict = function() {
	if ( window.SickManEmpireTime === SickManEmpireTime ) {
		window.SickManEmpireTime = _SickManEmpireTime;
	}
...
if ( typeof noGlobal === "undefined" ) {
	window.SickManEmpireTime = SickManEmpireTime;
}
